...
int main(void)
{
	...
	// log_info(t_log* logger, const char* message, ...) __attribute__((format(printf, 2, 3)));
	...
	//log_info(logger, "La ip de config es: %s", ip);
	//log_info(logger, "El puerto de config es: %s", puerto);
